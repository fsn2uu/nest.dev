...
@section('content')
    ...
    <h1>Unit Limit Reached</h1>
    <p>It looks like you've reached the maximum number of unit allowed on the plan you're subscribed to.  You are currently subscribed to the <strong>{{ $current }}</strong> plan.</p>
    <p>Don't worry, though, there's definitely a plan that can handle more units:</p>
