...
@section('content')
    ...
    <h1>
        ...
        @if (\Auth::user()->canDeleteComplexes())
            <a href="{{ route('complexes.delete', $complex->id) }}" class="btn btn-danger float-right" onclick="return conf2();">Delete Complex</a>
        @endif
    </h1>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="tab-content mt-2" id="complexInfoContent">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            value="{{ old('phone2') ?: $complex->phone2 }}" />
                        ...
                        <div class="form-group">
                            ...
                            value="{{ old('toll_free') ?: $complex->toll_free }}" />
                        ...
                        <div class="form-group">
                            ...
                            value="{{ old('website') ?: $complex->website }}" />
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            value="{{ old('address') ?: $complex->address }}" />
                        ...
                        <div class="form-group">
                            ...
                            value="{{ old('address2') ?: $complex->address2 }}" placeholder="Suite #, Apt #, etc." />
                        ...
                        <div class="form-group">
                            ...
                            {{ $errors->has('content') ? 'is-invalid' : '' }}">{{ old('description') ?: $complex->description }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select name="amenities[]" id="amenities" class="form-control {{ $errors->has('amenities') ? 'has-error' : '' }}" multiple>
                        @foreach (\App\Amenity::where('type', 'c')->orderBy('name')->get() as $r)
                            <option value="{{ $r->id }}" {{ $complex->amenities()->where('amenity_id', $r->id)->count() > 0 ? 'selected' : '' }}>{{ $r->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="tab-pane fade" id="photos" role="tabpanel" aria-labelledby="photos-tab">
                        ...
                        @foreach ($complex->photos as $pic)
                            <div class="card" data-id="{{ $pic->id }}">
                                ...
                                <div class="card-footer">
                                    ...
                                    data-path="{{ asset('storage/'.\Auth::user()->company_id.'/complexes/'.$complex->id.'/'.$pic->filename) }}"
                ...
                @else
                    <div class="row">
                        <div class="col-xs-12 col-md-8">
                            <p>There are no photos for this complex yet.  Upload some to get started:</p>
                ...
                <div class="row mt-5">
                    <div class="col-xs-12 col-md-8">
                        <label>Add Complex Photos</label>
                        <div class="custom-file mb-3">
                            <input type="file" name="photos[]" class="custom-file-input" id="photos" multiple>
                            <label class="custom-file-label" for="photos">Choose files</label>
                        </div>
                ...
                <div class="col-xs-12 col-md-8">
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control {{ $errors->has('status') ? 'has-error' : '' }}">
                            <option value="draft" {{ old('status') == 'draft' ? 'selected' : $complex->status == 'draft' ? 'selected' : '' }}>Draft</option>
                            <option value="active" {{ old('status') == 'active' ? 'selected' : $complex->status == 'active' ? 'selected' : '' }}>Active</option>
                        </select>
                        <span class="feedback">Only active complexes will be shown</span>
        ...
        <input type="submit" value="Edit Complex" class="btn btn-primary mt-5">
    </form>
